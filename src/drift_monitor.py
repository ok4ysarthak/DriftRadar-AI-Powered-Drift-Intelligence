...
# --- Project Root & Paths ---
PROJECT_ROOT = "/app" # Set to the container's root directory
MODEL_PATH = os.path.join(PROJECT_ROOT, "model_artifacts", "churn_model.pkl") # Correct model file name
DATA_STREAMS_DIR = os.path.join(PROJECT_ROOT, "data_streams")
